...
- 🗄️ I'm into all things data: data migration using tailored solutions, development of APIs for data integration between systems, design of data models for new projects, development of dashboards for data exploitation...
...
- ☁️ The cloud infrastructure I'm more used to is Amazon's, but I don't fear Microsoft's or Google's. I prefer cloud agnostic stacks, though!

- 📱 I also have some basic experience in mobile app development. I have developed some Progressive Web Apps on Angular, and I find particularly enjoyable developing the frontend for my own backends from time to time 😉.
...
When it comes to managing enterprise data, two important things are worth considering: data quality and FAIR principles.
...
In addition, data can become outdated as business processes change, new technologies are introduced, or regulatory requirements evolve, complicating things even further.
...
In data engineering, four typical needs of data have become popular as a single concept known as the **FAIR data principles**:
...
FAIR data principles are a set of guiding principles for achieving such goals. They provide a framework for managing and sharing data in a way that maximizes its potential for reuse and discovery.

In order to achieve that, we usually focus on:

- Making data fully machine-readable
- Providing useful metadata
- Attaching persistent and unique identifiers
- Applying standard vocabularies

In this way, the data can be easily discovered, accessed, and used by humans and machines alike.

Projects that aim for attaining FAIR principles can tap into a lot of added value from a business intelligence perspective.

---

## How to contact me

Do you want to get in touch? Do you have a project proposal for me?
...
Don't hesitate to take a look at some of my repositories or ask for more information about any specific project that may draw your attention.
